...
| [**Blocky**](https://github.com/0xERR0R/blocky) | Go | Schlank, extrem schnell | Der flinke Flitzer | ✅ Ja | Minimalisten |
| [**Gravity**](https://github.com/BeryJu/gravity) | Go | Replizierbar (etcd), DNS+DHCP | Die Kommandozentrale | ⚠️ (via Blocky) | Homelabber |
| [**CoreDNS**](https://coredns.io/) | Go | Plugin-basiert, Cloud-native | Der modulare Baukasten | ⚠️ (via Plugin) | DevOps |

---

## 🛠️ Hardware-Optionen

*   **Der Klassiker:** Ein **Raspberry Pi** (Pi 3, 4 oder 5).
*   **Der Server-Weg:** Als **Docker-Container** auf einem NAS (Synology, QNAP, Unraid).
*   **Upcycling:** Ein alter Laptop oder ein ausrangierter Thin Client (z. B. Fujitsu Futro).
...
2. Klicke auf **IPv4-Konfiguration**.
...
---
<p align="center">
  <a href="00-vanilla-dns.md">🍦 Stufe 0</a> | <a href="01-alternative-dns.md">⚡ Stufe 1</a> | <a href="02-dns-verschluesselt.md">💊 Stufe 2</a> | <a href="03-dns-verschluesselt-adblock.md">🛡️ Stufe 3</a> | <a href="04-cloud-adblocker.md">☁️ Stufe 4</a> | 🏠 Stufe 5 | <a href="06-testing.md">🧪 Stufe 6</a> | <a href="07-sources.md">📚 Stufe 7</a>
</p>
<p align="center">
